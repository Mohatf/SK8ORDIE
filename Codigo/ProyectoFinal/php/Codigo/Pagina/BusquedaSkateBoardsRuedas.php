...
session_start();
$categoria=4;
$listarProductos=buscarProductos($conexion,$variableBusqueda, $categoria);
...
if(mysqli_num_rows($listarProductos)==0){
    ...
    while($productos=mysqli_fetch_array($listarProductos)){
        if($_SESSION['usuarioConectado']==true){
            ...
            <img  src="data:image/jpeg;base64,'.base64_encode($productos['Imagen']).'" class="mx-auto mt-2 d-block" width="150px" height="150px"/>
                <div class="card-body">
