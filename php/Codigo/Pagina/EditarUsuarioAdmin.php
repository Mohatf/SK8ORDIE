        ...
        <div class="perfil-usuario-body">
            ...
            <div class="perfil-usuario-footer">
                <ul class="lista-datos">
                    ...
                    <li><i class="icono fas fa-home"></i> Dirección: <span  id="direccionAj" ></span> <a href="#" data-direccion="<?php echo $usuario['Direccion'];?>" class="boton-editarDireccion"><i class="fas fa-edit"></i></a></li>
                    <li><i class="icono fas fa-map-marker-alt"></i> C. Autónoma: <span  id="caAj" ></span> <a href="#" data-ca="<?php echo $usuario['ComunidadAutonoma'];?>" class="boton-editarCa"><i class="fas fa-edit"></i></a></li>
                    <li><i class="icono fas fa-map-marker-alt"></i> Provincia: <span  id="provinciaAj" ></span> <a href="#" data-provincia="<?php echo $usuario['Provincia'];?>" class="boton-editarProvincia"><i class="fas fa-edit"></i></a></li>
                </ul>
                <ul class="lista-datos">
                    <li><i class="icono fas fa-map-marker-alt"></i> Ciudad: <span  id="ciudadAj" ></span> <a href="#" data-ciudad="<?php echo $usuario['Ciudad'];?>" class="boton-editarCiudad"><i class="fas fa-edit"></i></a></li>
                    <li><i class="icono fas fa-location-arrow"></i> Código Postal: <span  id="codPostAj" ></span> <a href="#" data-codPost="<?php echo $usuario['CodigoPostal'];?>" class="boton-editarCodPost"><i class="fas fa-edit"></i></a></li>
                    ...
                    <li><i class="icono fas fa-user-tag"></i>ROL: <span  id="rolAj" ></span> <a href="#" data-rol="<?php echo $usuario['Rol'];?>" class="boton-editarROL"><i class="fas fa-edit"></i></a></li>
                </ul>
               <div ><a href="AdministracionUsuarios.php" style="text-decoration:none;color:#25292d;"><i class="icono fas fa-arrow-left"></i> Volver al panel de administración</a></div>
            </div>
           <br>
        </div>
    </div>
    <!-- ESTA ES LA VENTANA EMERGENTE PARA CAMBIAR LA FOTO DE PERFIL -->
    <?php include 'ModalFotoPerfilUsuarioAdmin.php'; ?>
