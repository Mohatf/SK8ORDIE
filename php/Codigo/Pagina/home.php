...
<body class="body">
  ...
  <!-- //Llamamos al menú -->
    ...
    <section class="section-home">
      ...
      <h1 class="tituloHome">Bienvenido a SK8 OR DIE</h1>
  ...
  <section class="section-two">
    <div class="container-fluid mt-5">
      <div class="row">
        <div class="col-md-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid dignissimos rem neque. Magni iste iusto laudantium magnam repellendus a hic quasi praesentium ex consequatur quod consectetur culpa, eos officia! Nesciunt.</div>
        <div class="col-md-6">
